...
KERNELS = {
    ...
    "separability": "probe_separability",    # docs/12 P1 - are form factors separable at all
...
CONFIGS = {
    ...
    "quant": "validator",
    "residual": "validator",
    # P1 reads the identifier's crops and its taxonomy, not the validator's.
    "separability": "identifier",
